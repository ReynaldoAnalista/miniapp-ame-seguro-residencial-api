...
export class SmartphoneProposalRepository {
    ...
    async validateProposal(proposal) {
        ...
        let policyHolderData = proposal?.attributes?.customPayload?.proposal?.policyholder_data
        let insuredData = proposal?.attributes?.customPayload?.proposal?.insured_data
        let clientAdressData = insuredData?.address_data
        let adressData = policyHolderData?.address_data
        let equipamentRiskData = proposal?.attributes?.customPayload?.proposal?.portable_equipment_risk_data
        let coverageData = proposal?.attributes?.customPayload?.proposal?.coverage_data
        let variablePolicyData = proposal?.attributes?.customPayload?.proposal?.variable_policy_data
        let changeTypeData = proposal?.attributes?.customPayload?.proposal?.charge_type_data
        let policyData = proposal?.attributes?.customPayload?.proposal?.policy_data
