...
import { PortableProposalService } from "./PortableProposalService"

const readFile = util.promisify(fs.readFile)
const log = getLogger("PortableProposalMailService")
@injectable()
export class PortableProposalMailService {
    constructor(
    ...
    async sendSellingEmailByPaymentObject(unsignedPayment: any, emailPass?: string) {
        ...
        const emailTemplate = path.resolve(__dirname, "../../../../mail_template/portable_mail.html")
