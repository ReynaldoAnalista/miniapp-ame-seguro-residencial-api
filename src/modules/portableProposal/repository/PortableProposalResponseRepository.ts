...
const TABLE = `${process.env.DYNAMODB_ENV}_seguro_portateis_response`

const log = getLogger("PortableProposalResponseRepository")

@injectable()
export class PortableProposalResponseRepository {
    static TABLE = TABLE
